...
set xlabel 'Tamanho do Arquivo Original (Kb)'
...
plot 'ratio.results' using 1:2 title column(2) with lp pt 7 ps 0.2 , \
	 ...
	 'ratio.results' using 1:9 title column(9) with lp pt 7 ps 0.2, \
	 'ratio.results' using 1:10 title column(10) with lp pt 7 ps 0.2, \
	 'ratio.results' using 1:11 title column(11) with lp pt 7 ps 0.2, \
